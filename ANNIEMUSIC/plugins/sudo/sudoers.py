...
async def sudoers_list(client, message: Message):
    ...
    #await message.reply_photo(photo="https://graph.org/file/ffdb1be822436121cf5fd.png", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        ...
        keyboard.append([InlineKeyboardButton("💕 𝐁𝔞𝔠𝔨 🦋", callback_data="back_to_main_menu")])
