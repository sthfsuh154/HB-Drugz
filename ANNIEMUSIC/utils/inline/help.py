...
def first_page(_):
	controll_button = [InlineKeyboardButton(text="💕 𝐌𝔢𝔫𝔲 🦋", callback_data=f"settingsback_helper"), InlineKeyboardButton(text="💕 𝐍𝔢𝔵𝔱 🦋", callback_data=f"AYUSHI")]
...
def second_page(_):
	controll_button = [InlineKeyboardButton(text="💕 𝐁𝔞𝔠𝔨 🦋", callback_data=f"settings_back_helper")]
